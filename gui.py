...
class App:
    ...
    def create_project_screen(self):
        ...
        name_entry.pack(fill="x", pady=5, padx=55)
    ...
    def view_projects(self):
        ...
        ctk.CTkButton(frame, text="Volver", command=self.main_menu, corner_radius=25, font=self.font, height=15, fg_color="#6a0dad").pack(pady=5, padx=10)
    ...
    def view_tasks(self, project):
        ...
        if not tasks:
            ...
            for task in tasks:
                card = ctk.CTkFrame(frame, corner_radius=10, fg_color="#141414")
    ...
    def view_completed_tasks(self):
        ...
        if not completed_tasks:
            ...
            for task in completed_tasks:
                card = ctk.CTkFrame(frame, corner_radius=10, fg_color="#303A33")
        ...
        ctk.CTkButton(frame, text="Volver", command=self.main_menu, font=self.font, height=30, fg_color="#6a0dad").pack(pady=10, padx=20)
